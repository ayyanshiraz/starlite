...
export const categoriesData = [
  { 
    ...
    imageUrl: '/images/categories/computers-laptops.jpg', // <-- ADDED
    description: 'Latest laptops, desktops, and business computers.', // <-- ADDED
    seoTitle: 'Shop Computers & Laptops | Starlite Linker',
    metaDescription: 'Find the best deals on business computers, gaming laptops, and workstations from top brands at Starlite Linker.',
  ...
  { 
    ...
    imageUrl: '/images/categories/accessories.jpg', // <-- ADDED
    description: 'Keyboards, mice, docking stations, and more.', // <-- ADDED
    seoTitle: 'IT Accessories for Business | Starlite Linker',
  ...
  { 
    ...
    imageUrl: '/images/categories/switches.jpg', // <-- ADDED
    description: 'Managed and unmanaged network switches.', // <-- ADDED
    seoTitle: 'Network Switches (Cisco, Ubiquiti) | Starlite Linker',
  ...
  { 
    ...
    imageUrl: '/images/categories/printers.jpg', // <-- ADDED
    description: 'Reliable laser, inkjet, and all-in-one printers.', // <-- ADDED
    seoTitle: 'Business Printers & Scanners | Starlite Linker',
  ...
  { 
    ...
    imageUrl: '/images/categories/workstations.jpg', // <-- ADDED
    description: 'Powerful workstations for creative professionals.', // <-- ADDED
    seoTitle: 'High-Performance Workstations | Starlite Linker',
  ...
  { 
    ...
    imageUrl: '/images/categories/routers.jpg', // <-- ADDED
    description: 'Secure wireless routers for home and business.', // <-- ADDED
    seoTitle: 'Business & Home Routers | Starlite Linker',
  ...
  { 
    ...
    imageUrl: '/images/categories/ups.jpg', // <-- ADDED
    description: 'Protect your tech with battery backup systems.', // <-- ADDED
    seoTitle: 'Uninterruptible Power Supply (UPS) | Starlite Linker',
  ...
  { 
    ...
    imageUrl: '/about.jpg', // <-- ADDED
    description: 'Shop all top IT brands in one place.', // <-- ADDED
    seoTitle: 'Shop All Brands | Starlite Linker',
    metaDescription: 'Browse all top IT brands at Starlite Linker, including Dell, HP, Cisco, Microsoft, Lenovo, and more.',
