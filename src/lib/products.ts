...
    price: "Get a Quote",
    image: "/microsoft-docking-station/1.jpg",
...
// --- NEW: HIKVISION PRODUCTS (95 Total) ---
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/DS-2CD2666G2-IZS(2.8-12MM)c.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-6mp-ip-bullet-camera-ip66-h265-plus",
    description: {
      overview: "A professional-grade 6 Megapixel IP Bullet camera built for high-resolution security monitoring. Supports the efficient H.265+ compression standard to reduce bandwidth and storage requirements.",
      design: {
        title: "Design",
        formFactor: "Durable metal bullet form factor with an IP66 weather-resistant rating, making it ideal for outdoor installations.",
      },
      performance: {
        title: "Performance",
        processor: "Advanced image processing chip for 6MP resolution at real-time frame rates.",
        memory: "N/A",
        storage: "Supports microSD card slot for edge storage (up to 256GB).",
      },
      display: {
        title: "Display and Graphics",
        screen: "6MP resolution (3072 x 2048) for highly detailed video surveillance.",
        graphics: "Infrared (IR) range of up to 50 meters for clear night vision.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "12V DC Power input"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Features Digital Wide Dynamic Range (DWDR) for balanced images in high-contrast environments and motion detection alarms.",
        connectivityOptions: "PoE (Power over Ethernet) support simplifies installation by running both power and data over a single cable.",
      },
    },
  },
  {
    ...
    categorySlug: "accessories",
    slug: "hikvision-deepinview-ds-2td2617b-6-pa-thermal-camera",
    description: {
      overview: "A high-precision **thermal** and optical **Bi-spectrum** camera featuring DeepinView AI analytics, specializing in reliable fire prevention and perimeter protection.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with both thermal and optical lenses. Built-in heater for extreme weather conditions.",
      },
      performance: {
        title: "Performance",
        processor: "Advanced **Deep Learning Algorithm** for human and vehicle detection, and temperature anomaly alarm.",
        memory: "N/A",
        storage: "Supports on-board storage (microSD/SDHC/SDXC) up to 256GB.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Thermal resolution (160x120) and optical resolution (4MP) combined in a fused image.",
        graphics: "Accurate temperature measurement range of 30 °C to 45 °C for fever screening applications.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Alarm I/O", "Audio I/O"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Features **Smoke Detection**, **Temperature Anomaly Detection**, and **Intrusion Detection** based on fused thermal and optical images for high accuracy.",
        connectivityOptions: "PoE support and robust interface ports for integration into large surveillance systems.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ipc-b620-z.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-2mp-cmos-varifocal-network-bullet-camera-ipc-b620-z",
    description: {
      overview: "A versatility 2 Megapixel Network Bullet camera featuring a **vari-focal** lens, allowing the user to remotely adjust the focus and zoom for optimal coverage.",
      design: {
        title: "Design",
        formFactor: "Traditional bullet style camera, suitable for outdoor mounting. Durable metal housing.",
      },
      performance: {
        title: "Performance",
        processor: "2MP CMOS image sensor delivering 1920 x 1080 resolution at real-time 30 frames per second.",
        memory: "N/A",
        storage: "Supports local microSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Full HD 1080p video output.",
        graphics: "Motorized zoom and focus allows for easy remote field-of-view adjustments after installation.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Excellent low-light performance thanks to Digital WDR and built-in IR illumination.",
        connectivityOptions: "PoE support ensures quick and efficient single-cable deployment.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2747g2-lzs-3-6-9mm-c.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-acusense-motorized-varifocal-dome-2cd2747g2-lzs",
    description: {
      overview: "A 4 Megapixel outdoor dome camera with a **motorized lens** and **AcuSense** technology, offering high-quality video combined with advanced AI event classification.",
      design: {
        title: "Design",
        formFactor: "Vandal-resistant dome housing (IK10) with an IP67 weatherproof rating for reliable outdoor use.",
      },
      performance: {
        title: "Performance",
        processor: "Powered by Hikvisions G2 platform, enabling **AcuSense** deep learning algorithms for filtering out false alarms.",
        memory: "N/A",
        storage: "Supports on-board storage (microSD/SDHC/SDXC) up to 256GB.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4MP resolution and a wide vari-focal range (3.6mm-9mm) for flexible viewing angles.",
        graphics: "Darkfighter technology provides clear, colored images even in near-total darkness.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Focuses on accurate **human and vehicle target classification**, ignoring rain, leaves, and light changes.",
        connectivityOptions: "Motorized lens adjustment allows for quick remote setup and focus correction.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ipc-t640-z.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-cmos-motorized-turret-camera-ipc-t640-z",
    description: {
      overview: "A 4 Megapixel outdoor Turret camera with a **motorized vari-focal lens**, providing sharp images and the flexibility to adjust the field of view remotely.",
      design: {
        title: "Design",
        formFactor: "Turret camera style (eyeball dome) for easy ceiling or wall mounting. IP66 rated.",
      },
      performance: {
        title: "Performance",
        processor: "4MP CMOS sensor for 2560 x 1440 resolution at 30fps.",
        memory: "N/A",
        storage: "Supports microSD card slot for edge storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "Motorized focus and zoom eliminates manual adjustment at the camera site.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Features a wide IR range (up to 30 meters) and Digital WDR for reliable performance in low-light and high-contrast settings.",
        connectivityOptions: "PoE support streamlines installation and reduces cabling complexity.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2186g2-isu-2-8mm-c.jpg",
    category: "Hikvision, Network Camera, AcuSense",
    categorySlug: "accessories",
    slug: "hikvision-acusense-ai-dome-network-camera",
    description: {
      overview: "An advanced **AcuSense Dome** camera that minimizes false alarms by focusing on reliable **human and vehicle classification** rather than simple motion detection.",
      design: {
        title: "Design",
        formFactor: "Fixed dome design with a sleek, low-profile look, suitable for indoor and outdoor mounting.",
      },
      performance: {
        title: "Performance",
        processor: "Equipped with a deep learning algorithm chip to accurately distinguish between people/vehicles and irrelevant objects like rain, light, or animals.",
        memory: "N/A",
        storage: "Supports MicroSD card edge recording.",
      },
      display: {
        title: "Display and Graphics",
        screen: "High-resolution sensor (e.g. 4MP or 8MP) for clear identification.",
        graphics: "Built-in IR illumination for long-range night vision.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Ethernet port"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Quick target search function saves time by classifying video footage based on human or vehicle events.",
        connectivityOptions: "Supports PoE for simplified setup and seamless integration with Hikvision NVRs.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2t86g2-2i-4mm-c.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-digital-technology-bullet-network-camera",
    description: {
      overview: "A reliable **Digital Technology Bullet camera** offering essential features for standard indoor and outdoor video surveillance applications.",
      design: {
        title: "Design",
        formFactor: "Bullet form factor with a wall- or ceiling-mountable bracket and sunshield.",
      },
      performance: {
        title: "Performance",
        processor: "Standard image processor for reliable Full HD or greater resolution video streaming.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "Full HD or high-resolution video output for clear image capture.",
        graphics: "Features basic Digital WDR and noise reduction technologies for balanced imaging.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "An accessible, cost-effective solution for general-purpose monitoring.",
        connectivityOptions: "Supports PoE for power and data transmission.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2ae4215t-d3-c-1.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-8mp-4k-acusense-bullet-network-camera-ds-2cd2t86g2-2i",
    description: {
      overview: "An **8 Megapixel (4K) AcuSense Bullet Camera** built for extreme detail and smart event classification. Provides superior image clarity and reduced false alarms.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet camera with a **2.8mm fixed lens** for a wide field of view. IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "G2 platform chip enabling **AcuSense** to differentiate between people, vehicles, and other movement.",
        memory: "N/A",
        storage: "Supports up to 256GB MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Ultra HD 4K (3840 x 2160) resolution.",
        graphics: "Features **Darkfighter technology** for exceptional color and detail capture in ultra-low light conditions.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Accurate **perimeter protection** with minimal false alarms, allowing for quick response to real security threats.",
        connectivityOptions: "Supports PoE+ for simplified single-cable installation.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2746g2-izs-2-8-12mm-c.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-acusense-motorized-varifocal-dome-ir-ds-2cd2746g2",
    description: {
      overview: "A **4 Megapixel AcuSense Vandal-Resistant Dome Camera** with a **motorized varifocal lens** for flexible coverage and smart human/vehicle classification.",
      design: {
        title: "Design",
        formFactor: "Vandal-resistant dome (IK10) with an IP67 weatherproof rating. Motorized lens is remotely adjustable.",
      },
      performance: {
        title: "Performance",
        processor: "G2 platform chip provides **AcuSense** technology for efficient object classification.",
        memory: "N/A",
        storage: "Supports on-board storage (microSD/SDHC/SDXC) up to 256GB.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4MP resolution and a versatile **2.8mm to 12mm motorized zoom** range.",
        graphics: "Up to 40m IR range and 120dB Wide Dynamic Range (WDR) to manage challenging light conditions.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Alarm I/O", "Audio I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Perimeter protection features accurately focus on human and vehicle events, drastically reducing filtering time for security personnel.",
        connectivityOptions: "PoE support and robust I/O ports for alarm and audio integration.",
      },
    },
  },
  {
    ...
    categorySlug: "accessories",
    slug: "hikvision-turbo-hd-2mp-15x-ptz-camera-ds-2ae4215t-d3c",
    description: {
      overview: "A **Turbo HD Analog PTZ camera** with a **15x optical zoom**, offering high-speed panning and tilting for wide area surveillance in hybrid CCTV systems.",
      design: {
        title: "Design",
        formFactor: "Outdoor-rated mini-PTZ dome design for ceiling or wall mounting.",
      },
      performance: {
        title: "Performance",
        processor: "2MP image sensor delivering Full HD 1080p video over coaxial cable.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "1080p HD video output with a 15x optical zoom lens for monitoring distant objects.",
        graphics: "IR illumination effective up to 100 meters, supporting 3D intelligent positioning.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["BNC Analog video output", "RS-485 control input"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Features **Preset Positions**, **Patrol Scans**, and **Pattern Scans** to automate the surveillance of large areas.",
        connectivityOptions: "Uses coaxial cable for video signal and UTC (Up the Coax) protocol for PTZ control, simplifying wiring.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2ae5225ti-a-e.jpg",
    category: "Hikvision, PTZ Camera",
    categorySlug: "accessories",
    slug: "hikvision-turbo-hd-2mp-25x-ptz-camera-ds-2ae5225ti-a-e",
    description: {
      overview: "A high-power **Turbo HD Analog PTZ camera** with **25x optical zoom** and an integrated power supply, ideal for monitoring expansive outdoor areas.",
      design: {
        title: "Design",
        formFactor: "Large outdoor-rated PTZ dome, featuring a vandal-proof and weatherproof enclosure.",
      },
      performance: {
        title: "Performance",
        processor: "2MP image sensor delivering 1080p Full HD video over coaxial cable at high frame rates.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "Full HD 1080p video and **25x Optical Zoom** capability for high-detail surveillance at long range.",
        graphics: "Features powerful IR illumination up to 150 meters for excellent night performance.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["BNC Analog video output", "RS-485 control input"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Supports 3D Digital Noise Reduction (DNR) and Digital WDR for clear images in dynamic lighting conditions.",
        connectivityOptions: "Integrated power supply simplifies installation (AC 24V input).",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2025fwd-i-2-8mm.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-2mp-ip-mini-bullet-camera-ds-2cd2025fwd-i",
    description: {
      overview: "A compact and high-efficiency **2 Megapixel IP Mini Bullet camera** with 120dB WDR for superior image quality in varying light.",
      design: {
        title: "Design",
        formFactor: "Small, fixed mini-bullet design with IP67 weatherproof rating. Fixed lens for specific field of view.",
      },
      performance: {
        title: "Performance",
        processor: "2MP sensor supporting 1920x1080 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for on-board storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Full HD 1080p resolution.",
        graphics: "Features **120dB True WDR** to correctly expose both bright and dark areas of a scene simultaneously.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Supports basic smart features including line crossing, intrusion detection, and face detection.",
        connectivityOptions: "PoE support eliminates the need for separate power cables.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2047g2-lu-2-8mm-c.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-colorvu-ip-mini-bullet-ds-2cd2047g2-lu",
    description: {
      overview: "A 4 Megapixel **ColorVu IP Mini Bullet Camera** that captures **full-time color video** even in pitch-black environments, thanks to its super-aperture lens and warm supplementary light.",
      design: {
        title: "Design",
        formFactor: "Fixed mini-bullet with IP67 rating. Features a fixed lens and built-in white light illuminator.",
      },
      performance: {
        title: "Performance",
        processor: "G2 platform chip for 4MP high-resolution imaging.",
        memory: "N/A",
        storage: "Supports up to 256GB MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4MP resolution with **ColorVu** technology, eliminating grayscale video at night.",
        graphics: "Warm visible light illumination is effective up to 30 meters, acting as a deterrent.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Full-color video significantly improves the chances of capturing useful evidence at night, such as clothing color and license plates.",
        connectivityOptions: "PoE support simplifies deployment for a clean, professional installation.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2125g0-ims-2-8mm.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-2mp-ip-fixed-dome-with-mic-ds-2cd2125g0-ims",
    description: {
      overview: "A **2 Megapixel Fixed Dome camera** with **built-in audio input and output**, enabling two-way communication and audio monitoring on the network.",
      design: {
        title: "Design",
        formFactor: "Fixed dome camera with compact, vandal-resistant housing (IK10).",
      },
      performance: {
        title: "Performance",
        processor: "2MP CMOS sensor delivering Full HD 1080p video.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for on-board storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "1080p video resolution.",
        graphics: "Features **120dB True WDR** to ensure clear imaging against strong backlight.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Built-in Microphone"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Ideal for locations requiring simultaneous video and audio recording or two-way communication with a monitored area.",
        connectivityOptions: "PoE support and simple integration with Hikvision NVRs.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2143g0-i-2-8mm.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-ip-fixed-dome-camera-ds-2cd2143g0-i",
    description: {
      overview: "A high-value, high-resolution **4 Megapixel Fixed Dome camera** designed for dependable surveillance in a small form factor.",
      design: {
        title: "Design",
        formFactor: "Fixed dome design with IK10 vandal resistance and an IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "4MP CMOS sensor for clear video at 2560 x 1440 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for edge storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "Built-in IR illumination effective up to 30 meters.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Supports H.265+ video compression for maximum storage efficiency.",
        connectivityOptions: "PoE simplifies installation and reduces total system cost.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2145fwd-i-4mm.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-ip-fixed-dome-wdr-ds-2cd2145fwd-i",
    description: {
      overview: "A **4 Megapixel Fixed Dome camera** featuring **True 120dB WDR** for professional-grade imaging in areas with strong backlighting.",
      design: {
        title: "Design",
        formFactor: "Fixed dome camera with IK10 vandal resistance and an IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "4MP CMOS sensor delivering smooth 25fps video.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for local backup.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "**120dB True WDR** ensures all parts of the image, from shadows to highlights, are clearly visible.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Smart features include face detection and scene change detection.",
        connectivityOptions: "PoE support for simplified wiring.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-ip-dome-camera-wdr-ds-2cd2145fwd-i-variant",
    description: {
      overview: "A variant of the high-performance **4 Megapixel Fixed Dome camera**, optimized for areas that require detailed surveillance regardless of lighting contrast.",
      design: {
        title: "Design",
        formFactor: "Fixed dome with robust IK10 and IP67 ratings, suitable for high-risk indoor or outdoor locations.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor with high frame rate capability.",
        memory: "N/A",
        storage: "Supports edge storage via MicroSD card slot.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2560 x 1440 resolution.",
        graphics: "**120dB True WDR** and 3D Digital Noise Reduction (3D DNR) provide clean, detailed images.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Supports region of interest (ROI) coding to save bandwidth on static areas while keeping focus areas clear.",
        connectivityOptions: "PoE compliant for flexible power and network deployment.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2146g2-isu-4mm.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-acusense-dome-with-audio-ds-2cd2146g2-isu",
    description: {
      overview: "A premium **4 Megapixel AcuSense Dome camera** featuring a **built-in microphone and speaker** (ISU), enabling real-time audio and two-way talk functionality.",
      design: {
        title: "Design",
        formFactor: "Fixed dome design with IK10 vandal resistance and IP67 weather protection.",
      },
      performance: {
        title: "Performance",
        processor: "G2 AcuSense chipset for highly accurate human/vehicle detection.",
        memory: "N/A",
        storage: "Supports up to 256GB MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4MP resolution video capture.",
        graphics: "Features **Darkfighter** technology for superior color performance in low light.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Built-in Microphone", "Built-in Speaker"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Ideal for entry points or areas where voice interaction is required. Supports perimeter protection and instant audio alarms.",
        connectivityOptions: "PoE support and unified audio/video streaming.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-acusense-outdoor-dome-ds-2cd2146g2-isu-ip",
    description: {
      overview: "A robust **4 Megapixel AcuSense Dome camera** engineered for demanding **outdoor** applications, featuring advanced video analytics and high-resolution capture.",
      design: {
        title: "Design",
        formFactor: "Outdoor-rated dome enclosure with flexible ceiling or wall mounting options. IK10 and IP67 protection.",
      },
      performance: {
        title: "Performance",
        processor: "AcuSense technology ensures accurate perimeter security by identifying human and vehicle targets.",
        memory: "N/A",
        storage: "Supports MicroSD card up to 256GB.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4MP resolution (2592 x 1944) for crisp, detailed video.",
        graphics: "Excellent low-light performance using **Darkfighter** and 120dB WDR.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Alarm I/O", "Audio I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Provides effective intrusion and line crossing detection with minimal false positives, significantly improving operational efficiency.",
        connectivityOptions: "PoE support reduces the need for complex external power sources.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2163g0-i-2-8mm.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-6mp-ip-fixed-dome-camera-ds-2cd2163g0-i",
    description: {
      overview: "A super-high resolution **6 Megapixel Fixed Dome camera**, delivering extremely detailed images for applications where maximum clarity is needed.",
      design: {
        title: "Design",
        formFactor: "Fixed dome enclosure with IK10 vandal-resistance and IP67 weather protection.",
      },
      performance: {
        title: "Performance",
        processor: "6MP sensor providing 3072 x 2048 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for local storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "6MP resolution video output.",
        graphics: "Up to 30m IR range and 120dB WDR for reliable day and night surveillance.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Higher pixel density allows for greater digital zoom on recorded video without losing critical details.",
        connectivityOptions: "PoE support ensures quick and efficient setup.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2323g0-i-2-8mm.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-2mp-ip-turret-camera-ds-2cd2323g0-i",
    description: {
      overview: "A reliable and cost-effective **2 Megapixel Fixed Turret camera** offering solid image quality and ease of installation.",
      design: {
        title: "Design",
        formFactor: "Turret camera style (eyeball dome) with a flexible three-axis adjustment for accurate targeting. IP67 rated.",
      },
      performance: {
        title: "Performance",
        processor: "2MP CMOS image sensor for 1080p resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for edge storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Full HD 1080p video output.",
        graphics: "Features Digital WDR and 3D DNR for clear images in various lighting conditions.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Supports line crossing and intrusion detection for basic smart security monitoring.",
        connectivityOptions: "PoE simplifies wiring and reduces installation complexity.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2346g1-i-2-8mm.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-darkfighter-turret-ds-2cd2346g1-i",
    description: {
      overview: "A **4 Megapixel Turret camera** featuring **Darkfighter** technology for superior low-light performance and clear night-time surveillance.",
      design: {
        title: "Design",
        formFactor: "Fixed turret design, highly adjustable, with an IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor providing clear 2K resolution video.",
        memory: "N/A",
      ...
      display: {
        title: "Display and Graphics",
        screen: "2560 x 1440 resolution.",
        graphics: "**Darkfighter** technology ensures exceptional image detail and color rendition in very low ambient light.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Smart features include behavior analysis and face detection, enhancing security intelligence.",
        connectivityOptions: "PoE support for simplified power management.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2347g1-lu-2-8mm.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-colorvu-turret-camera-ds-2cd2347g1-lu",
    description: {
      overview: "A **4 Megapixel ColorVu Turret camera** that delivers **vibrant, full-color video 24/7**, eliminating the need for traditional grayscale IR video at night.",
      design: {
        title: "Design",
        formFactor: "Turret camera design with built-in warm LED supplementary light and IP67 rating.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor with high-sensitivity components optimized for color capture.",
        memory: "N/A",
        storage: "Supports MicroSD card up to 128GB.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2560 x 1440 resolution video output.",
        graphics: "**ColorVu** technology uses an F1.0 aperture lens and advanced sensor to maintain color integrity in minimal light.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "The supplementary white light acts as a visual deterrent while ensuring color accuracy for better evidence capture.",
        connectivityOptions: "PoE simplifies installation and power delivery.",
      },
    },
  },
  {
    ...
    name: "Hikvision Digital Technology DS-2CD2347G1-LU",
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2347g1-lu-4mm.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-ip-turret-camera-colorvu-ds-2cd2347g1-lu-variant",
    description: {
      overview: "A variant of the powerful **4 Megapixel ColorVu Turret camera** for 24/7 color monitoring, perfect for capturing critical details in dark areas.",
      design: {
        title: "Design",
        formFactor: "Turret design with a rugged IP67 weatherproof rating and integrated warm LED lighting.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor delivers high-resolution, full-color video constantly.",
        memory: "N/A",
        storage: "Supports on-board storage for local recording.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2K resolution at high frame rates.",
        graphics: "F1.0 Super Aperture lens maximizes light capture to produce vivid color images in low light.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Minimizes the guesswork associated with black-and-white night vision by retaining color information in the footage.",
        connectivityOptions: "PoE support for clean, unified power and network infrastructure.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2347g2-lu-2-8mm-c.jpg",
    category: "Hikvision, PTZ Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-acusense-colorvu-turret-ds-2cd2347g2-lu",
    description: {
      overview: "A **4 Megapixel Turret camera** that combines **ColorVu** (24/7 color) with **AcuSense** (AI human/vehicle detection), offering best-in-class perimeter protection.",
      design: {
        title: "Design",
        formFactor: "Turret camera with IP67 rating. Integrates white light illuminator and fixed lens.",
      },
      performance: {
        title: "Performance",
        processor: "G2 platform combines color imaging hardware with deep learning software for intelligent security.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4MP resolution with vivid color detail at night.",
        graphics: "AcuSense filters false alarms, providing accurate event classification on colored footage.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Focuses resources on real threats (people or vehicles) and captures undeniable, full-color evidence of the event.",
        connectivityOptions: "PoE support for simple, cost-effective installation.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2383g0-i-2-8mm.jpg",
    category: "Hikvision, PTZ Camera",
    categorySlug: "accessories",
    slug: "hikvision-8mp-4k-ip-turret-camera-ds-2cd2383g0-i",
    description: {
      overview: "An ultra-high resolution **8 Megapixel (4K) Fixed Turret camera** for applications demanding maximum pixel density and clarity.",
      design: {
        title: "Design",
        formFactor: "Fixed turret design with an IP67 rating for reliable outdoor use.",
      },
      performance: {
        title: "Performance",
        processor: "8MP sensor providing 3840 x 2160 resolution video at 20fps.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for local storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4K UHD video output.",
        graphics: "Up to 30m IR range and 120dB WDR for high-contrast scenes.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "The 4K resolution provides wide-area coverage and extreme detail for forensic analysis.",
        connectivityOptions: "PoE support for streamlined power delivery.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2386g2-isu-sl-2-8mm-c.jpg",
    category: "Hikvision, PTZ Camera",
    categorySlug: "accessories",
    slug: "hikvision-8mp-acusense-color-siren-turret-ds-2cd2386g2",
    description: {
      overview: "A specialized **8 Megapixel AcuSense Turret Camera** featuring **Sound and Light Strobe Alarm (SL)** for active deterrence, plus two-way audio (ISU).",
      design: {
        title: "Design",
        formFactor: "Turret camera with integrated strobe light and speaker/microphone. IP67 rated.",
      },
      performance: {
        title: "Performance",
        processor: "AcuSense technology triggers the alarm only upon detection of human or vehicle targets.",
        memory: "N/A",
        storage: "Supports MicroSD card up to 256GB.",
      },
      display: {
        title: "Display and Graphics",
        screen: "8MP 4K resolution.",
        graphics: "The built-in strobe light and audible alarm (siren or custom audio) actively deter intruders.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Built-in Speaker/Mic"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Provides **active deterrence** by warning trespassers away, reducing the need for security intervention.",
        connectivityOptions: "PoE support and two-way audio enables remote voice command and verification.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2386g2-iu-2-8mm-c.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-8mp-acusense-turret-builtin-mic-ds-2cd2386g2-iu",
    description: {
      overview: "An **8 Megapixel AcuSense Turret Camera** that includes a **built-in microphone (IU)** for simultaneous video and audio monitoring.",
      design: {
        title: "Design",
        formFactor: "Turret camera with a sleek design and IP67 weather rating.",
      },
      performance: {
        title: "Performance",
        processor: "G2 AcuSense chipset provides object classification for reliable motion and perimeter alarms.",
        memory: "N/A",
        storage: "Supports MicroSD card up to 256GB.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4K (8MP) resolution for high-definition video capture.",
        graphics: "Darkfighter technology ensures excellent low-light performance.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Built-in Microphone"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Captures ambient sounds and conversations, adding an extra layer of context and evidence to recorded video footage.",
        connectivityOptions: "PoE support and simple integration with NVRs.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2387g2p-lsu-sl-4mm-c.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-8mp-acusense-color-strobe-light-turret-ds-2cd2387g2p",
    description: {
      overview: "A professional **8 Megapixel ColorVu Turret Camera** featuring **AcuSense AI, full-time color, and Strobe Light (SL) active deterrence**.",
      design: {
        title: "Design",
        formFactor: "Turret camera with white light illuminator and strobe alarm capability. IP67 rated.",
      },
      performance: {
        title: "Performance",
        processor: "G2 chipset performs AcuSense filtering on the high-quality ColorVu image data.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "8MP (4K) resolution, capturing color video 24/7.",
        graphics: "Combines the benefits of high resolution, full color, and active deterrence in one unit.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Built-in Speaker/Mic"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "The most advanced perimeter defense, using AI to identify threats and deter them with a flashing light before they commit a crime.",
        connectivityOptions: "PoE supported for streamlined power and network connection.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2623g0-izs-2-8-12mm.jpg",
    category: "Hikvision, Switch",
    categorySlug: "switches",
    slug: "hikvision-2mp-motorized-varifocal-bullet-ds-2cd2623g0-izs",
    description: {
      overview: "A **2 Megapixel Motorized Varifocal Bullet camera** designed for flexible installation and remote viewing angle adjustment.",
      design: {
        title: "Design",
        formFactor: "Bullet camera form factor with IP67 weather resistance and a sun shield.",
      },
      performance: {
        title: "Performance",
        processor: "2MP CMOS sensor delivering Full HD 1080p video.",
      ...
      display: {
        ...
        graphics: "**Motorized varifocal lens (IZS)** allows users to remotely adjust the focal length and focus from the NVR or app.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Audio I/O", "Alarm I/O"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Ideal for long corridors or large areas where the field of view must be customized during or after installation.",
        connectivityOptions: "PoE support and integrated I/O ports for complex alarm linkage.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2645fwd-izs.jpg",
    category: "Hikvision, NVR",
    categorySlug: "accessories",
    slug: "hikvision-4mp-varifocal-bullet-ds-2cd2645fwd-izs",
    description: {
      overview: "A high-performance **4 Megapixel Motorized Varifocal Bullet camera** with 120dB True WDR for excellent image clarity in all light conditions.",
      design: {
        title: "Design",
        formFactor: "Bullet camera with IP67 rating and remote zoom/focus capability.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor providing 2560 x 1440 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "**120dB True WDR** ensures highly detailed video by eliminating overexposed or underexposed areas.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Motorized zoom allows for precise optical adjustment from a centralized location.",
        connectivityOptions: "PoE support reduces the complexity of power and data cabling.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/DS-2CD2686G2-IZS.jpg",
    category: "Hikvision, NVR",
    categorySlug: "accessories",
    slug: "hikvision-8mp-4k-acusense-motorized-bullet-ds-2cd2686g2",
    description: {
      overview: "An **8 Megapixel (4K) AcuSense Motorized Varifocal Bullet camera** for ultra-high-definition perimeter security with intelligent object detection.",
      design: {
        title: "Design",
        formFactor: "Bullet camera with IP67 rating and highly adjustable motorized lens.",
      },
      performance: {
        title: "Performance",
        processor: "G2 platform combines 4K sensor data with AcuSense AI for accurate human and vehicle filtering.",
        memory: "N/A",
        storage: "Supports up to 256GB MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4K Ultra HD (8MP) resolution.",
        graphics: "Darkfighter technology provides clear, low-noise images at night.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Audio I/O", "Alarm I/O"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Allows the installer to remotely set the optical zoom level and precisely focus the 4K image.",
        connectivityOptions: "PoE support and smart I/O ports for complete security integration.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2745fwd-izs-2-8-12mm.jpg",
    category: "Hikvision, NVR",
    categorySlug: "accessories",
    slug: "hikvision-4mp-varifocal-dome-ds-2cd2745fwd-izs",
    description: {
      overview: "A **4 Megapixel Motorized Varifocal Dome camera** with **IK10 vandal resistance**, offering flexible remote zoom control and superior image quality.",
      design: {
        title: "Design",
        formFactor: "Vandal-resistant dome (IK10) with IP67 weatherproof rating. Motorized lens is remotely controllable.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor providing 2K resolution video.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2560 x 1440 resolution.",
        graphics: "Features **120dB True WDR** to capture detail in both dark and bright areas.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "The motorized lens allows for perfect field-of-view setup from the comfort of the control room.",
        connectivityOptions: "PoE support and robust I/O for alarm and audio accessories.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2786g2-izs-2-8-12mm-c.jpg",
    category: "Hikvision, NVR",
    categorySlug: "accessories",
    slug: "hikvision-8mp-4k-acusense-motorized-dome-ds-2cd2786g2",
    description: {
      overview: "An **8 Megapixel (4K) AcuSense Motorized Varifocal Dome camera** with enhanced deep learning algorithms and ultra-high-resolution detail.",
      design: {
        title: "Design",
        formFactor: "Vandal-resistant dome with IP67 rating. **2.8mm to 12mm motorized zoom** lens.",
      },
      performance: {
        title: "Performance",
        processor: "G2 AcuSense chipset delivers high-accuracy detection and classification on 4K footage.",
        memory: "N/A",
        storage: "Supports up to 256GB MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4K Ultra HD (8MP) resolution.",
        graphics: "**Darkfighter** technology and 120dB WDR combine for best-in-class low-light performance.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for covering vast areas with complex detection needs, providing highly reliable perimeter protection alerts.",
        connectivityOptions: "PoE support ensures simplified power management despite the camera's high performance.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2t43g0-i5-2-8mm.jpg",
    category: "Hikvision, NVR",
    categorySlug: "accessories",
    slug: "hikvision-4mp-exir-fixed-bullet-ds-2cd2t43g0-i5",
    description: {
      overview: "A **4 Megapixel Fixed Bullet camera** featuring **EXIR 2.0 technology** for enhanced infrared night vision effectiveness and uniformity.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with an extended **IR range (I5)**, suitable for long-distance outdoor monitoring.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor providing 2560 x 1440 resolution.",
      ...
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "**EXIR 2.0** uses highly efficient LEDs to deliver uniform illumination and eliminate the hot spot effect common with traditional IR.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Long-range IR illumination makes this camera ideal for monitoring parking lots, long driveways, or building perimeters.",
        connectivityOptions: "PoE supported for simplified installation.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2t47g2-l-4mm-c.jpg",
    category: "Hikvision, NVR",
    categorySlug: "accessories",
    slug: "hikvision-4mp-colorvu-acusense-fixed-bullet-ds-2cd2t47g2-l",
    description: {
      overview: "A 4 Megapixel Fixed Bullet camera combining **ColorVu** (24/7 color) with **AcuSense AI**, providing powerful, intelligent, and colorful security surveillance.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with IP67 rating and integrated white light illuminator.",
      },
      performance: {
        title: "Performance",
        processor: "G2 AcuSense chipset delivers highly accurate event filtering and object classification.",
        memory: "N/A",
        storage: "Supports up to 256GB MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4MP resolution with full-time color video capture.",
        graphics: "F1.0 Super Aperture lens and advanced sensor technology ensures vivid colors in ultra-low light.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Provides the clarity of color video combined with the intelligence of AI, drastically reducing security alerts from non-threats.",
        connectivityOptions: "PoE support for simplified, centralized power management.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2t87g2-l-4mm-c.jpg",
    category: "Hikvision, Intercom",
    categorySlug: "accessories",
    slug: "hikvision-8mp-4k-colorvu-fixed-bullet-ds-2cd2t87g2-l",
    description: {
      overview: "An **8 Megapixel (4K) Fixed Bullet camera** featuring **ColorVu** technology, offering ultra-high-definition, full-color video capture around the clock.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with an IP67 rating and integrated warm LED supplementary light.",
      },
      performance: {
        title: "Performance",
        processor: "8MP sensor captures 4K video resolution in full color, even at night.",
        memory: "N/A",
        storage: "Supports up to 256GB MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4K UHD resolution.",
        graphics: "F1.0 Super Aperture ensures optimal light gathering for bright, clear color images in minimal light.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Provides the highest level of detail and color information for crucial applications like license plate identification and evidence capture.",
        connectivityOptions: "PoE support for clean, unified power and network infrastructure.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd6924f-is-4mm.jpg",
    category: "Hikvision, Intercom",
    categorySlug: "accessories",
    slug: "hikvision-180-degree-pano-multi-sensor-camera-ds-2cd6924f-is",
    description: {
      overview: "A **180-degree multi-sensor PanoVu camera** that uses four separate lenses to stitch together a seamless, high-resolution panoramic view.",
      design: {
        title: "Design",
        formFactor: "Fixed dome design containing four independent camera modules within a single housing.",
      },
      performance: {
        title: "Performance",
        processor: "Combines four 2MP images to create an 8MP effective panoramic resolution (4 x 1920 x 1080).",
        memory: "N/A",
        storage: "Supports MicroSD card storage for local backup.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Seamless 180° horizontal field of view.",
        graphics: "Smart features include heat mapping and intrusion detection across the entire panoramic image.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for monitoring large, open areas like building fronts, parking lots, or plazas with a single camera and a single IP address.",
        connectivityOptions: "PoE support simplifies wiring for this complex camera unit.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2ce56h0t-it3e-2-8mm.jpg",
    category: "Hikvision, Intercom",
    categorySlug: "accessories",
    slug: "hikvision-5mp-turbo-hd-fixed-dome-ds-2ce56h0t-it3e",
    description: {
      overview: "A high-resolution **5 Megapixel Turbo HD (HD-TVI) Fixed Dome camera** designed for high-performance analog surveillance systems.",
      design: {
        title: "Design",
        formFactor: "Fixed dome camera with IP67 weather rating. Features a **long-range IR (IT3E)** for night vision.",
      },
      performance: {
        title: "Performance",
        processor: "5MP CMOS sensor delivers 2560 x 1944 resolution video over coaxial cable.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "5MP resolution video output.",
        graphics: "EXIR 2.0 technology provides uniform IR illumination up to 40 meters.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["BNC Analog video output"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "The **Turbo HD** format allows for 5MP video transmission over existing coaxial cable infrastructure, simplifying upgrades from older analog systems.",
        connectivityOptions: "Supports UTC (Up the Coax) protocol for remote camera menu configuration.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2ce56h0t-itme-2-8mm.jpg",
    category: "Hikvision, PTZ Camera",
    categorySlug: "accessories",
    slug: "hikvision-5mp-turbo-hd-mini-dome-ds-2ce56h0t-itme",
    description: {
      overview: "A **5 Megapixel Turbo HD Mini Dome camera** that provides high-resolution video in a compact, discreet form factor.",
      design: {
        title: "Design",
        formFactor: "Mini dome camera for discrete mounting. IP67 weather rating and compact size.",
      },
      performance: {
        title: "Performance",
        processor: "5MP sensor delivers 2560 x 1944 resolution video over coaxial cable.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "5MP resolution video output.",
        graphics: "Up to 20m IR range and Digital WDR for clear imaging.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["BNC Analog video output"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for indoor or outdoor applications where a high-resolution, low-profile camera is required.",
        connectivityOptions: "Connects to a Turbo HD DVR via coaxial cable.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2de5425iw-ae-t5.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4mp-25x-optical-zoom-ip-ptz-dome-ds-2de5425iw-ae",
    description: {
      overview: "A powerful **4 Megapixel IP PTZ Dome camera** featuring a **25x optical zoom** and up to 150m IR range for expansive, automated surveillance.",
      design: {
        title: "Design",
        formFactor: "Large outdoor-rated PTZ dome. Designed for high-speed panning and tilting.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor delivering 2560 x 1440 resolution.",
        memory: "N/A",
        storage: "Supports up to 256GB MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video and 25x optical zoom for remote detail capture.",
        graphics: "Up to 150m IR distance for long-range night vision.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Alarm I/O", "Audio I/O"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Features intelligent tracking, customizable patrols, and up to 300 presets for automated monitoring of large areas.",
        connectivityOptions: "PoE+ support and integrated I/O for alarm system integration.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2de7225iw-ae.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-2mp-25x-optical-zoom-ip-ptz-dome-ds-2de7225iw-ae",
    description: {
      overview: "A professional **2 Megapixel IP PTZ Dome camera** with **25x optical zoom**, offering high-speed, 360-degree coverage for large areas.",
      design: {
        title: "Design",
        formFactor: "Large outdoor-rated PTZ dome, designed for continuous high-speed movement and reliable outdoor operation.",
      },
      performance: {
        title: "Performance",
        processor: "2MP sensor providing Full HD 1080p video.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "1080p Full HD video and **25x optical zoom** for viewing distant objects with clarity.",
        graphics: "Up to 150m IR range for superior night monitoring.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Alarm I/O", "Audio I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Supports intelligent tracking of moving objects and automatically zooms in to capture detail.",
        connectivityOptions: "PoE+ support and alarm I/O integration for automated security response.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2df6225x-ael.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-2mp-darkfighter-25x-ip-ptz-ds-2df6225x-ael",
    description: {
      overview: "An executive-level **2 Megapixel IP PTZ camera** featuring **Darkfighter technology** and a powerful **25x optical zoom** for extreme low-light performance.",
      design: {
        title: "Design",
        formFactor: "High-end outdoor-rated PTZ dome with advanced environmental protection.",
      },
      performance: {
        title: "Performance",
        processor: "2MP sensor combined with Darkfighter technology for exceptional low-light video capture.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "1080p Full HD video.",
        graphics: "**Darkfighter** minimizes noise and maximizes light sensitivity, providing color images in near-dark conditions.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Alarm I/O", "Audio I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for city surveillance and complex scenarios. Includes smart features like line crossing and face detection.",
        connectivityOptions: "PoE+ support and comprehensive I/O for system integration.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2td2617-3-v1.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-bi-spectrum-thermal-bullet-ds-2td2617-3-v1",
    description: {
      overview: "A **Bi-spectrum Thermal and Optical Bullet camera** that captures thermal (heat) and visible light images simultaneously for enhanced security and early detection.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with two parallel lenses: one thermal and one optical (visible light).",
      },
      performance: {
        title: "Performance",
        processor: "Advanced image fusion technology overlays thermal and optical data for clearer images in difficult conditions (fog, smoke).",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Thermal sensor (160x120) and optical sensor (e.g. 4MP).",
        graphics: "Accurate fire detection and thermal measurement capabilities.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Alarm I/O", "Audio I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Highly effective for **perimeter protection** (human detection through bushes, smoke) and monitoring areas where fire risk is present.",
        connectivityOptions: "PoE support and robust I/O for alarm integration.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2td2636b-15-p.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-thermal-and-optical-bi-spectrum-bullet-ds-2td2636b-15-p",
    description: {
      overview: "A professional **Bi-spectrum Thermal and Optical Bullet camera** with enhanced thermal resolution and long-distance detection capabilities.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with powerful thermal and optical lenses.",
      },
      performance: {
        title: "Performance",
        processor: "Supports advanced thermal analysis features like line crossing and region entry detection based on heat signatures.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Enhanced thermal sensor (384 x 288) and high-resolution optical sensor.",
        graphics: "Capable of long-distance human and vehicle detection based on thermal signatures.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Alarm I/O", "Audio I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for critical infrastructure protection, border security, and industrial monitoring where fire and intrusion must be detected regardless of lighting.",
        connectivityOptions: "PoE support and integrated I/O for complex system linkage.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-3e0310hp-e.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-8-port-poe-plus-unmanaged-network-switch-ds-3e0310hp-e",
    description: {
      overview: "An 8-Port **Unmanaged PoE+ Network Switch** with 2 high-power ports, designed to power IP cameras and other PoE devices.",
      design: {
        title: "Design",
        formFactor: "Compact, desktop-sized metal chassis with a fanless design for quiet operation.",
      },
      performance: {
        title: "Performance",
        processor: "N/A",
      ...
      display: {
        title: "Display and Graphics",
        screen: "N/A",
        graphics: "LED indicators for power, link/activity, and PoE status.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["8x 10/100M PoE+ ports", "2x 10/100M non-PoE uplink ports"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Features **Extended PoE Mode** for long-distance power and data transmission (up to 300m) on specific ports, ideal for distant cameras.",
        connectivityOptions: "Plug-and-play setup for instant network expansion.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-7204huhi-k1-p.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-4-channel-turbo-hd-dvr-poe-over-coax-ds-7204huhi-k1-p",
    description: {
      overview: "A 4-Channel **Turbo HD Hybrid DVR** with **PoC (Power over Coax)** technology, allowing compatible cameras to be powered directly through the coaxial cable.",
      design: {
        title: "Design",
        formFactor: "Compact desktop DVR chassis in black, supporting one SATA hard drive (up to 10TB).",
      },
      performance: {
        title: "Performance",
        processor: "Supports up to 5MP/8MP (Turbo HD) camera input.",
        memory: "N/A",
        storage: "Supports one SATA HDD.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI and VGA output supporting 4K resolution.",
        graphics: "**PoC** greatly simplifies cabling by eliminating the need for separate power supplies for PoC-compatible cameras.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["4x BNC PoC inputs", "1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Supports multiple formats including HDTVI, AHD, CVI, CVBS, and up to 4 IP cameras, enabling a wide range of camera compatibility.",
        connectivityOptions: "Centralized management and recording for hybrid systems.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-7208hqhi-k2-p.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-8-channel-turbo-hd-dvr-poe-over-coax-ds-7208hqhi-k2-p",
    description: {
      overview: "An **8-Channel Turbo HD Hybrid DVR** with **PoC (Power over Coax)** and H.265+ compression, offering efficient high-resolution recording for medium-sized systems.",
      design: {
        title: "Design",
        formFactor: "Desktop DVR chassis supporting up to two SATA hard drives.",
      },
      performance: {
        title: "Performance",
        processor: "Supports up to 4MP (Turbo HD) camera input per channel.",
        memory: "N/A",
        storage: "Supports two SATA HDDs.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI and VGA output supporting Full HD resolution.",
        graphics: "**PoC** reduces the need for complex, separate power infrastructure for compatible cameras.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["8x BNC PoC inputs", "1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Features intelligent search and efficient H.265+ compression to maximize recording time.",
        connectivityOptions: "Hybrid capability allows integration of both analog (TVI/AHD/CVI) and IP cameras.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-7216huhi-k2-p.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-16-channel-turbo-hd-dvr-poe-over-coax-ds-7216huhi-k2-p",
    description: {
      overview: "A **16-Channel Turbo HD Hybrid DVR** with **PoC (Power over Coax)**, built for large-scale analog and hybrid security installations demanding high-channel density and simplified cabling.",
      design: {
        title: "Design",
        formFactor: "1.5U rack-mountable DVR chassis supporting two SATA hard drives.",
      },
      performance: {
        title: "Performance",
        processor: "Supports up to 8MP (Turbo HD) camera input per channel.",
        memory: "N/A",
        storage: "Supports two SATA HDDs.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K UHD resolution.",
        graphics: "**PoC** technology significantly lowers installation costs and complexity by using existing coaxial cable for power transmission.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["16x BNC PoC inputs", "1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Provides long-distance video transmission over coaxial cable and supports multiple video formats for maximum compatibility.",
        connectivityOptions: "Centralized power and data management for up to 16 PoC-enabled cameras.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-7608ni-k1-8p-c.jpg",
    category: "Hikvision, Network Camera",
    categorySlug: "accessories",
    slug: "hikvision-8-channel-4k-nvr-with-8-port-poe-ds-7608ni-k1-8p",
    description: {
      overview: "An **8-Channel 4K Network Video Recorder (NVR)** with a **built-in 8-port PoE switch**, offering a simplified plug-and-play solution for IP camera systems.",
      design: {
        title: "Design",
        formFactor: "Compact 1U rack-mountable NVR chassis.",
      },
      performance: {
        title: "Performance",
        processor: "Supports up to 8MP/12MP IP camera resolution.",
        memory: "N/A",
        storage: "Supports one SATA hard drive (up to 8TB).",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI and VGA output supporting 4K UHD resolution.",
        graphics: "Decodes H.265+ video for massive storage savings.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["8x PoE outputs (for cameras)", "1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "The integrated PoE switch powers all 8 cameras directly from the NVR, eliminating the need for an external switch or power supply.",
        connectivityOptions: "Plug-and-play functionality makes setup extremely fast and simple for small-to-medium IP camera deployments.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-7616ni-i2-16p.jpg",
    category: "Hikvision, NVR, PoE",
    categorySlug: "accessories",
    slug: "hikvision-16-channel-4k-nvr-with-16-poe-ports-ds-7616ni-i2-16p",
    description: {
      overview: "A professional **16-Channel 4K NVR** with a **built-in 16-port PoE switch**, designed for medium to large IP surveillance systems.",
      design: {
        title: "Design",
        formFactor: "1U rack-mountable NVR chassis with two SATA interfaces.",
      },
      performance: {
        title: "Performance",
        processor: "Supports up to 12MP resolution recording and efficient H.265+ compression.",
        memory: "N/A",
        storage: "Supports two SATA hard drives (up to 8TB each).",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K Ultra HD resolution.",
        graphics: "The integrated **16-port PoE switch** powers cameras directly, simplifying installation and reducing hardware complexity.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["16x PoE Ports (for cameras)", "1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Plug-and-play setup for cameras and advanced features like two-way audio and alarm I/O integration.",
        connectivityOptions: "Ideal for systems requiring a high number of cameras with centralized power and video management.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-7732ni-i4-kb-cvbs.jpg",
    category: "Hikvision, NVR",
    categorySlug: "accessories",
    slug: "hikvision-32-channel-4k-nvr-4-sata-ds-7732ni-i4-kb-cvbs",
    description: {
      overview: "A high-capacity **32-Channel 4K NVR** (I-Series) designed for enterprise surveillance systems, supporting a large number of cameras and extensive storage.",
      design: {
        title: "Design",
        formFactor: "1.5U rack-mountable chassis with support for four SATA hard drives.",
      },
      performance: {
        title: "Performance",
        processor: "Capable of recording cameras up to 12MP and provides high decoding capability for simultaneous viewing.",
        memory: "N/A",
        storage: "Supports **four SATA hard drives** (up to 10TB each) for large-scale video archiving.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K resolution.",
        graphics: "Features key control (KB) for physical keyboard connectivity and CVBS (BNC) output for legacy monitors.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["2x RJ-45 Gigabit Ethernet ports", "4x SATA Interfaces", "HDMI/VGA/CVBS outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Ideal for mission-critical applications and central control rooms requiring long-term, high-resolution recording.",
        connectivityOptions: "Dual Gigabit Ethernet ports provide network redundancy and high bandwidth connectivity.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-kh6320-wte1.jpg",
    category: "Hikvision, Intercom, Indoor Station",
    categorySlug: "accessories",
    slug: "hikvision-7-inch-touchscreen-wifi-video-intercom-indoor-station-ds-kh6320-wte1",
    description: {
      overview: "A **7-inch touchscreen indoor station** for Hikvision video intercom systems, providing video communication and door control.",
      design: {
        title: "Design",
        formFactor: "Wall-mounted indoor station with a slim, black design and a 7-inch capacitive touchscreen.",
      },
      performance: {
        title: "Performance",
        processor: "Runs the intercom software smoothly for video calls and system control.",
        memory: "N/A",
        storage: "Supports MicroSD card for image capture and messages.",
      },
      display: {
        title: "Display and Graphics",
        screen: "7-inch (1024 x 600) color TFT LCD touchscreen.",
        graphics: "Displays live video from door stations and connected cameras.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Alarm inputs"],
        wireless: ["Integrated Wi-Fi"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Allows residents to view visitor video, open the door remotely, and communicate with other indoor stations.",
        connectivityOptions: "Supports PoE and Wi-Fi for flexible network connection options.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-kis603-p-b.jpg",
    category: "Hikvision, Intercom System, Video Door Phone",
    categorySlug: "accessories",
    slug: "hikvision-video-intercom-kit-poe-ds-kis603-p",
    description: {
      overview: "A complete **Video Intercom Kit** (DS-KIS603-P) consisting of a video door station and a 7-inch indoor monitor, fully powered by PoE.",
      design: {
        title: "Design",
        formFactor: "Kit includes a stylish 7-inch indoor station and a durable outdoor door station with a built-in camera.",
      },
      performance: {
        title: "Performance",
        processor: "Door station features a high-quality camera and microphone/speaker for clear communication.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "7-inch color display on the indoor station.",
        graphics: "Outdoor station provides wide-angle video capture with IR illumination.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["Door Station: RJ-45 PoE input", "Indoor Station: RJ-45 PoE input"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Provides two-way video communication with visitors, remote door unlocking, and 24-hour monitoring capability.",
        connectivityOptions: "The entire system is powered by **PoE (Power over Ethernet)**, minimizing cabling and installation time.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-kis603-p.jpg",
    category: "Hikvision, Intercom System, Video Door Phone",
    categorySlug: "accessories",
    slug: "hikvision-video-intercom-system-accessory-ds-kis603-p-variant",
    description: {
      overview: "A variant of the DS-KIS603-P **Video Intercom Kit**, offering an all-in-one solution for door communication and access control.",
      design: {
        title: "Design",
        formFactor: "Includes a sleek, modern door station and a wall-mounted indoor touch monitor.",
      },
      performance: {
        title: "Performance",
        processor: "The door station supports access control functions via Mifare cards (on some versions).",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "Indoor station displays live video and system status.",
        graphics: "High-quality wide-angle video ensures the visitor is fully visible.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["PoE connectivity on both units"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Ideal for villas, small offices, and multi-unit residences. Allows for call forwarding to a mobile app.",
        connectivityOptions: "Simple, two-wire installation (PoE) for quick deployment.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2ae4215t-d3.jpg",
    category: "Hikvision, PTZ Camera, Turbo HD",
    categorySlug: "accessories",
    slug: "hikvision-turbo-hd-2mp-15x-optical-zoom-ptz-camera-ds-2ae4215t-d3c",
    description: {
      overview: "A **Turbo HD Analog PTZ camera** with **15x optical zoom** and up to 100m IR range, providing long-distance surveillance in high-definition analog format.",
      design: {
        title: "Design",
        formFactor: "Outdoor mini-PTZ dome design.",
      },
      performance: {
        title: "Performance",
        processor: "2MP CMOS sensor delivers 1080p resolution over coaxial cable.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "Full HD 1080p video output.",
        graphics: "15x optical zoom allows for detailed remote monitoring and long-distance views.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["BNC Analog video output", "RS-485 control input"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Features presets, patrols, and pattern scans for automated monitoring. Supports Up the Coax (UTC) control.",
        connectivityOptions: "Compatible with Turbo HD DVRs for centralized control and recording.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Bullet",
    categorySlug: "accessories",
    slug: "hikvision-6mp-ip-fixed-bullet-camera-ds-2cd2065g1-i",
    description: {
      overview: "A high-resolution **6 Megapixel IP Fixed Bullet camera** with 120dB WDR and EXIR 2.0 technology for superior night vision.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with IP67 weatherproof rating and integrated EXIR IR illumination.",
      },
      performance: {
        title: "Performance",
        processor: "6MP sensor delivers 3072 x 2048 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "6MP resolution video output.",
        graphics: "EXIR 2.0 provides highly efficient and uniform IR illumination up to 50 meters.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "High-resolution sensor allows for greater digital zoom on recorded footage without losing detail.",
        connectivityOptions: "PoE supported for simplified installation.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Dome",
    categorySlug: "accessories",
    slug: "hikvision-2mp-ip-fixed-dome-camera-ds-2cd2123g0-i",
    description: {
      overview: "A reliable **2 Megapixel Fixed Dome camera** offering Full HD video and a compact design with vandal and weather protection.",
      design: {
        title: "Design",
        formFactor: "Fixed dome enclosure with IK10 vandal resistance and IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "2MP CMOS sensor delivers 1920 x 1080 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for edge storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Full HD 1080p resolution.",
        graphics: "Features Digital WDR and up to 30m IR range.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "A cost-effective camera for general surveillance in various indoor and outdoor environments.",
        connectivityOptions: "PoE support for simplified wiring.",
      },
    },
  },
  {
    ...
    slug: "hikvision-4mp-ip-fixed-dome-camera-ds-2cd2143g0-i",
    description: {
      overview: "A high-resolution **4 Megapixel Fixed Dome camera** designed for dependable surveillance in high-detail areas.",
      design: {
        title: "Design",
        formFactor: "Fixed dome with IK10 vandal resistance and IP67 weather protection.",
      },
      performance: {
        title: "Performance",
        processor: "4MP CMOS sensor delivers 2560 x 1440 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for edge storage.",
      },
      display: {
  ...
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2123g0-i.jpg",
    category: "Hikvision, Network Camera, Dome, Audio",
    categorySlug: "accessories",
    slug: "hikvision-4mp-ip-fixed-dome-audio-alarm-ds-2cd2143g0-is",
    description: {
      overview: "A **4 Megapixel Fixed Dome camera** featuring an **audio and alarm interface (IS)** for enhanced security monitoring and integration.",
      design: {
        title: "Design",
        formFactor: "Fixed dome with IK10 vandal resistance and IP67 weather protection.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor delivers 2560 x 1440 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for edge storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "Up to 30m IR range and Digital WDR.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "The integrated I/O ports allow for connection to external microphones, speakers, and alarm sensors, enabling complex system linkage.",
        connectivityOptions: "PoE support simplifies installation.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Dome",
    categorySlug: "accessories",
    slug: "hikvision-4mp-ip-fixed-dome-120db-wdr-ds-2cd2145fwd-i",
    description: {
      overview: "A **4 Megapixel Fixed Dome camera** with superior **120dB True WDR** technology, ensuring clear, high-detail video capture in strongly backlit environments.",
      design: {
        title: "Design",
        formFactor: "Fixed dome with IK10 vandal resistance and IP67 weather protection.",
      },
      ...
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "**120dB True WDR** ensures perfect exposure, eliminating shadows and overexposed areas in high-contrast scenes.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for monitoring building entrances, windows, and areas where lighting conditions change rapidly.",
        connectivityOptions: "PoE support for simplified wiring.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Dome",
    categorySlug: "accessories",
    slug: "hikvision-6mp-ip-fixed-dome-camera-ds-2cd2163g0-ii",
    description: {
      overview: "A **6 Megapixel Fixed Dome camera** providing exceptionally high image detail for critical identification applications.",
      design: {
        title: "Design",
        formFactor: "Fixed dome enclosure with IK10 vandal-resistance and IP67 weather protection.",
      },
      performance: {
        title: "Performance",
        processor: "6MP sensor delivering 3072 x 2048 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for local storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "6MP resolution video output.",
        graphics: "High pixel density allows for superior forensic digital zoom on recorded video.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Supports region of interest (ROI) coding to optimize bandwidth usage while maintaining high quality where it matters most.",
        connectivityOptions: "PoE supported for unified power and data.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2163g0-i.jpg",
    category: "Hikvision, Network Camera, 4K Dome",
    categorySlug: "accessories",
    slug: "hikvision-8mp-4k-ip-fixed-dome-camera-ds-2cd2183g0-i",
    description: {
      overview: "An **8 Megapixel (4K) Fixed Dome camera**, providing Ultra HD resolution for maximum coverage and pixel density.",
      design: {
        title: "Design",
        formFactor: "Fixed dome enclosure with IK10 vandal-resistance and IP67 weather protection.",
      },
      performance: {
        title: "Performance",
        processor: "8MP sensor delivers 3840 x 2160 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for local storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4K UHD resolution video output.",
        graphics: "Reduces the number of cameras required by covering a wider area while maintaining critical detail.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Supports H.265+ video compression to manage the higher bandwidth demand of 4K video efficiently.",
        connectivityOptions: "PoE supported for quick and efficient single-cable deployment.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Turret",
    categorySlug: "accessories",
    slug: "hikvision-4mp-ip-fixed-turret-wdr-ds-2cd2345fwd-i",
    description: {
      overview: "A **4 Megapixel Fixed Turret camera** with 120dB WDR, offering excellent imaging performance in dynamic and low-light outdoor conditions.",
      design: {
        title: "Design",
        formFactor: "Fixed turret design (eyeball dome) with IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor delivers 2560 x 1440 resolution.",
      ...
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "**120dB True WDR** ensures uniform clarity when the scene contains very bright and very dark areas.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Supports line crossing, intrusion detection, and face detection for smart monitoring.",
        connectivityOptions: "PoE simplifies wiring and supports rapid deployment.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Turret",
    categorySlug: "accessories",
    slug: "hikvision-4mp-darkfighter-ip-turret-ds-2cd2346g1-i",
    description: {
      overview: "A **4 Megapixel Fixed Turret camera** featuring **Darkfighter technology** for exceptional low-light image capture and superior night visibility.",
      design: {
        title: "Design",
        formFactor: "Fixed turret design with IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor delivers 2560 x 1440 resolution.",
      ...
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "**Darkfighter** minimizes noise and retains color and detail in extremely low ambient light conditions.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for monitoring large areas where clear night-time identification is critical.",
        connectivityOptions: "PoE support for simple, centralized power and data.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2346g2-iu-2-8mm-c.jpg",
    category: "Hikvision, Network Camera, AcuSense Turret",
    categorySlug: "accessories",
    slug: "hikvision-4mp-acusense-audio-turret-ds-2cd2346g2-iu",
    description: {
      overview: "A **4 Megapixel AcuSense Turret camera** with **built-in microphone (IU)** for audio monitoring and intelligent human/vehicle detection.",
      design: {
        title: "Design",
        formFactor: "Fixed turret design with IP67 rating and integrated mic.",
      },
      performance: {
        title: "Performance",
        processor: "G2 AcuSense chipset accurately filters false alarms caused by rain, leaves, or animals.",
        memory: "N/A",
        storage: "Supports MicroSD card up to 256GB.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4MP resolution video capture.",
        graphics: "Darkfighter technology provides excellent low-light performance.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Built-in Microphone"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Combines video and audio evidence with smart motion filtering for a highly reliable security system.",
        connectivityOptions: "PoE support simplifies wiring and provides unified power and data.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, ColorVu Turret",
    categorySlug: "accessories",
    slug: "hikvision-4mp-ip-colorvu-turret-camera-ds-2cd2347g1-lu",
    description: {
      overview: "A **4 Megapixel ColorVu Turret camera** that captures **vibrant, full-color video 24/7**, featuring an F1.0 super-aperture lens.",
      design: {
        title: "Design",
        formFactor: "Turret camera design with a built-in warm LED supplementary light and IP67 rating.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor and F1.0 lens maximizes light utilization for color fidelity in near-darkness.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "2560 x 1440 resolution video output.",
        graphics: "**ColorVu** technology provides clear, colored images at night, improving the quality of forensic evidence.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for commercial properties and homes where accurate color identification is required around the clock.",
        connectivityOptions: "PoE support for simple, efficient single-cable installation.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2355fwd-i-b.jpg",
    category: "Hikvision, Network Camera, Turret",
    categorySlug: "accessories",
    slug: "hikvision-5mp-ip-fixed-turret-wdr-ds-2cd2355fwd-ib",
    description: {
      overview: "A high-performance **5 Megapixel Fixed Turret camera** with True 120dB WDR, providing high-resolution video in demanding lighting conditions.",
      design: {
        title: "Design",
        formFactor: "Fixed turret design with IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "5MP sensor delivers 2560 x 1920 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for edge storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "5MP resolution video output.",
        graphics: "**120dB True WDR** ensures perfectly balanced images, revealing detail in both shadows and highlights.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Features smart detection capabilities including line crossing and intrusion detection.",
        connectivityOptions: "PoE support simplifies installation.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Turret",
    categorySlug: "accessories",
    slug: "hikvision-6mp-ip-fixed-turret-camera-ds-2cd2363g0-i",
    description: {
      overview: "A **6 Megapixel Fixed Turret camera** providing superior image clarity for high-detail surveillance applications.",
      design: {
        title: "Design",
        formFactor: "Fixed turret design with an IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "6MP sensor delivers 3072 x 2048 resolution.",
      ...
      display: {
        title: "Display and Graphics",
        screen: "6MP resolution video output.",
        graphics: "High pixel density allows for expansive coverage and detailed digital zoom.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Supports H.265+ compression for efficient video streaming and storage.",
        connectivityOptions: "PoE supported for centralized power and data.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Turret",
    categorySlug: "accessories",
    slug: "hikvision-6mp-darkfighter-ip-turret-ds-2cd2365g1-i",
    description: {
      overview: "A **6 Megapixel Fixed Turret camera** featuring **Darkfighter technology** for exceptional low-light performance and superior clarity at night.",
      design: {
        title: "Design",
        formFactor: "Fixed turret design with an IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "6MP sensor combined with Darkfighter optics for excellent light sensitivity.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for edge storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "6MP resolution video output.",
        graphics: "Darkfighter minimizes image noise and provides clearer night-time footage than standard IR cameras.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for low-light environments, providing high-quality images for reliable identification and evidence gathering.",
        connectivityOptions: "PoE support simplifies installation.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, 4K Turret",
    categorySlug: "accessories",
    slug: "hikvision-8mp-4k-darkfighter-turret-ds-2cd2385g1-i",
    description: {
      overview: "An **8 Megapixel (4K) Darkfighter Turret camera** offering Ultra HD resolution combined with superior low-light sensitivity.",
      design: {
        title: "Design",
        formFactor: "Fixed turret design with IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "8MP sensor captures 3840 x 2160 resolution video.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for local storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4K UHD video output.",
        graphics: "Darkfighter technology ensures high-quality 4K footage even in challenging low-light conditions.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Provides exceptional detail over wide areas, minimizing the number of cameras required while maintaining video integrity at night.",
        connectivityOptions: "PoE support simplifies wiring and installation.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Mini Dome",
    categorySlug: "accessories",
    slug: "hikvision-1-3mp-ip-mini-dome-audio-alarm-ds-2cd2512f-is",
    description: {
      overview: "A compact **1.3 Megapixel Mini Dome camera** with **Audio and Alarm I/O (IS)**, ideal for discreet and interactive surveillance applications.",
      design: {
        title: "Design",
        formFactor: "Low-profile fixed mini dome, suitable for indoor use or discreet outdoor mounting (IP66).",
      },
      performance: {
        title: "Performance",
        processor: "1.3MP sensor delivers 1280 x 960 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for edge storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HD 960p resolution video output.",
        graphics: "Features Digital WDR and 3D DNR for improved image clarity.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Allows for two-way audio (with external speaker/mic) and integration with external sensors or alarms.",
        connectivityOptions: "PoE support simplifies installation and provides centralized power and data.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2623g0-izs.jpg",
    category: "Hikvision, Network Camera, Varifocal Bullet",
    categorySlug: "accessories",
    slug: "hikvision-2mp-motorized-varifocal-bullet-ds-2cd2623g0-izs",
    description: {
      overview: "A **2 Megapixel Motorized Varifocal Bullet camera** with **remote zoom and focus (IZS)**, offering flexibility for viewing angle adjustment and installation ease.",
      design: {
        title: "Design",
        formFactor: "Bullet camera with IP67 weatherproof rating.",
      },
      performance: {
        title: "Performance",
        processor: "2MP sensor delivers Full HD 1080p video.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for edge storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "1080p resolution video output.",
        graphics: "Motorized zoom capability allows precise optical configuration from a centralized location.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for installations where the exact field of view needs to be precisely controlled after mounting.",
        connectivityOptions: "PoE support simplifies wiring, requiring only a single cable for power and data.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2646g2-izs-2-8-12mm-c.jpg",
    category: "Hikvision, Network Camera, AcuSense Bullet",
    categorySlug: "accessories",
    slug: "hikvision-4mp-acusense-motorized-varifocal-bullet-ds-2cd2646g2-izs",
    description: {
      overview: "A **4 Megapixel AcuSense Motorized Varifocal Bullet camera** with intelligent human/vehicle detection and remote zoom/focus control.",
      design: {
        title: "Design",
        formFactor: "Bullet camera with IP67 rating and remote motorized lens.",
      },
      performance: {
        title: "Performance",
        processor: "G2 AcuSense chipset accurately filters false alarms, focusing only on human or vehicle events.",
        memory: "N/A",
        storage: "Supports up to 256GB MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4MP resolution video output.",
        graphics: "Darkfighter technology provides excellent low-light performance.",
      },
      connectivity: {
        title: "Connectivity",
      ...
      functionality: {
        title: "Functionality",
        versatility: "The combination of AcuSense and motorized zoom ensures highly accurate, customizable perimeter security.",
        connectivityOptions: "PoE support and smart I/O ports for complete security integration.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Varifocal Dome",
    categorySlug: "accessories",
    slug: "hikvision-4mp-motorized-varifocal-dome-wdr-ds-2cd2745fwd-izs",
    description: {
      overview: "A **4 Megapixel Motorized Varifocal Dome camera** with True 120dB WDR and remote zoom/focus, ideal for high-contrast, high-detail indoor/outdoor surveillance.",
      design: {
        title: "Design",
        formFactor: "Vandal-resistant dome (IK10) with IP67 rating.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor delivers 2560 x 1440 resolution.",
      ...
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "**120dB True WDR** ensures all areas of the image are clearly exposed.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Motorized zoom capability simplifies installation and post-installation adjustments from the control room.",
        connectivityOptions: "PoE support and versatile I/O ports for alarm linkage.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, 4K Varifocal Dome",
    categorySlug: "accessories",
    slug: "hikvision-8mp-4k-motorized-varifocal-dome-ds-2cd2785g0-izs",
    description: {
      overview: "An **8 Megapixel (4K) Motorized Varifocal Dome camera**, offering ultra-high-definition video with remote zoom and focus capabilities.",
      design: {
        title: "Design",
        formFactor: "Vandal-resistant dome (IK10) with IP67 rating and weatherproof housing.",
      },
      performance: {
        title: "Performance",
        processor: "8MP sensor delivers 4K UHD resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card slot for edge storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "4K UHD resolution video output.",
        graphics: "Motorized lens provides flexible adjustment of the 4K viewing area after the camera is installed.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for covering large or complex scenes where high-detail forensic evidence is necessary.",
        connectivityOptions: "PoE support simplifies wiring and reduces installation complexity.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Varifocal Turret",
    categorySlug: "accessories",
    slug: "hikvision-4mp-motorized-varifocal-turret-wdr-ds-2cd2h45fwd-izs",
    description: {
      overview: "A **4 Megapixel Motorized Varifocal Turret camera** (H-series) with 120dB WDR, offering superior imaging and remote zoom/focus control.",
      design: {
        title: "Design",
        formFactor: "Turret camera design with flexible mounting options and IP67 rating.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor delivers 2560 x 1440 resolution.",
      ...
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "**120dB True WDR** ensures balanced video capture in areas with difficult lighting.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Motorized lens allows precise optical adjustments to be made remotely, saving time and ensuring optimal coverage.",
        connectivityOptions: "PoE support simplifies installation and provides centralized power and data.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2cd2t43g0-i5-2-8mm.jpg",
    category: "Hikvision, Network Camera, Long Range Bullet",
    categorySlug: "accessories",
    slug: "hikvision-4mp-long-range-ir-bullet-ds-2cd2t43g0-i5",
    description: {
      overview: "A **4 Megapixel Fixed Bullet camera** featuring **EXIR 2.0 and long-range IR (I5)**, designed for reliable outdoor night-time surveillance.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with IP67 weatherproof rating and long-distance IR illumination.",
      },
      performance: {
        title: "Performance",
        processor: "4MP sensor delivers 2560 x 1440 resolution.",
      ...
      display: {
        title: "Display and Graphics",
        screen: "2K resolution video output.",
        graphics: "**EXIR 2.0** provides efficient, uniform IR illumination for clear images up to 50 meters away.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for monitoring large perimeters, parking lots, or long driveways where extended night vision is necessary.",
        connectivityOptions: "PoE support simplifies installation and reduces cabling.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Network Camera, Long Range Bullet",
    categorySlug: "accessories",
    slug: "hikvision-6mp-long-range-ir-bullet-ds-2cd2t63g0-i5",
    description: {
      overview: "A **6 Megapixel Fixed Bullet camera** with **EXIR 2.0 and long-range IR (I5)**, combining high resolution with reliable long-distance night vision.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with IP67 weatherproof rating and integrated EXIR IR illumination.",
      },
      ...
      display: {
        title: "Display and Graphics",
        screen: "6MP resolution video output.",
        graphics: "**EXIR 2.0** technology provides highly efficient IR illumination up to 50 meters, eliminating hot spots.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 10/100M Ethernet port"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "The high resolution and long IR range make it suitable for large-area monitoring and forensic digital zoom.",
        connectivityOptions: "PoE support for simplified wiring.",
      },
    },
  },
  {
    ...
    category: "Hikvision, PanoVu Camera, Multi-Sensor",
    categorySlug: "accessories",
    slug: "hikvision-16mp-pano-vu-multi-sensor-camera-ds-2cd6924f-is",
    description: {
      overview: "A **Multi-sensor PanoVu camera** offering an ultra-wide, stitched **180-degree field of view** at high resolution from a single IP address.",
      design: {
        title: "Design",
        formFactor: "Fixed dome design containing four independent camera modules within a single housing.",
      },
      performance: {
        title: "Performance",
        processor: "Combines images from four sensors to create a high-resolution, seamless panoramic view.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "180° panoramic coverage at high resolution (e.g., 16MP combined).",
        graphics: "Smart features include heat mapping and people counting across the entire wide area.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Audio I/O", "Alarm I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Reduces the number of cameras and NVR channels required to cover a large, expansive area like a sports field or city street.",
        connectivityOptions: "PoE support simplifies wiring for this high-power unit.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Turbo HD Camera, Varifocal Bullet",
    categorySlug: "accessories",
    slug: "hikvision-2mp-turbo-hd-motorized-varifocal-bullet-ds-2ce16d8t-it3ze",
    description: {
      overview: "A **2 Megapixel Turbo HD Bullet camera** featuring a **motorized varifocal lens (ZE)**, allowing remote adjustment of the zoom and focus over coaxial cable.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with an IP67 weatherproof rating and long-range IR.",
      },
      performance: {
        title: "Performance",
        processor: "2MP sensor delivers 1080p resolution over coaxial cable.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "Full HD 1080p video output.",
        graphics: "**Motorized zoom** allows precise adjustment of the field of view from the DVR interface.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["BNC Analog video output"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for upgrading analog systems, as the HD-TVI technology transmits HD video, power, and PTZ control over existing coaxial infrastructure.",
        connectivityOptions: "Connects to a Turbo HD DVR via coaxial cable.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Turbo HD Camera, Box",
    categorySlug: "accessories",
    slug: "hikvision-8mp-4k-turbo-hd-box-camera-ds-2ce37u8t-a",
    description: {
      overview: "An **8 Megapixel (4K) Turbo HD Box camera** providing ultra-high-definition analog video capture.",
      design: {
        title: "Design",
        formFactor: "Box-style camera body, typically requiring a separate lens and housing for outdoor use.",
      },
      performance: {
        title: "Performance",
        processor: "8MP sensor delivers 3840 x 2160 resolution over coaxial cable.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "4K UHD resolution video output.",
        graphics: "The box form factor allows for the use of various C/CS mount lenses to customize the field of view and focal length.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["BNC Analog video output", "Alarm I/O", "Audio I/O"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Ideal for specialized applications where high resolution, interchangeable lenses, or specific housing (e.g., thermal) are required.",
        connectivityOptions: "Connects to a Turbo HD DVR via coaxial cable.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2ce72kf3t-le-2-8mm.jpg",
    category: "Hikvision, Turbo HD Camera, ColorVu Turret",
    categorySlug: "accessories",
    slug: "hikvision-3k-5mp-turbo-hd-colorvu-turret-ds-2ce72kf3t-le",
    description: {
      overview: "A **3K (5MP effective) Turbo HD Turret camera** featuring **ColorVu** technology to capture **24/7 full-color video** over coaxial cable.",
      design: {
        title: "Design",
        formFactor: "Fixed turret design with integrated warm LED supplementary light.",
      },
      performance: {
        title: "Performance",
        processor: "High-sensitivity sensor and F1.0 super-aperture lens maximize light capture for color video.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "3K resolution (2960x1665) video output.",
        graphics: "**ColorVu** eliminates the grayscale video output at night, significantly improving evidence quality.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["BNC Analog video output"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "The continuous color capture makes this camera an excellent and simple upgrade for existing analog CCTV systems.",
        connectivityOptions: "Connects to a compatible Turbo HD DVR via coaxial cable.",
      },
    },
  },
  {
    ...
    category: "Hikvision, PTZ Camera, 25x Zoom",
    categorySlug: "accessories",
    slug: "hikvision-2mp-25x-optical-zoom-ip-ptz-ds-2de5225w-ae",
    description: {
      overview: "A professional **2 Megapixel IP PTZ Dome camera** with **25x optical zoom** and 150m IR range for wide area, high-speed automated monitoring.",
      design: {
        title: "Design",
        formFactor: "Large outdoor-rated PTZ dome, capable of high-speed panning and tilting.",
      },
      performance: {
        title: "Performance",
        processor: "2MP sensor delivers Full HD 1080p video.",
      ...
      display: {
        title: "Display and Graphics",
        screen: "1080p Full HD video and **25x optical zoom** for viewing distant objects.",
        graphics: "Up to 150m IR distance for superior night performance.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Alarm I/O", "Audio I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Features intelligent tracking, customizable patrols, and up to 300 presets for automated coverage.",
        connectivityOptions: "PoE+ support and integrated I/O for alarm system integration.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-2de5225w-ae.jpg",
    category: "Hikvision, PTZ Camera, 30x Zoom",
    categorySlug: "accessories",
    slug: "hikvision-3mp-30x-optical-zoom-ip-ptz-ds-2de5330w-ae",
    description: {
      overview: "A powerful **3 Megapixel IP PTZ Dome camera** with an extensive **30x optical zoom** capability for monitoring vast outdoor spaces.",
      design: {
        title: "Design",
        formFactor: "Large outdoor-rated PTZ dome, engineered for high-speed, continuous surveillance.",
      },
      performance: {
        title: "Performance",
        processor: "3MP sensor delivers 2048 x 1536 resolution.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "3MP resolution video and **30x optical zoom** for maximum long-range detail capture.",
        graphics: "Features Smart IR to adjust IR illumination intensity automatically.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Alarm I/O", "Audio I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for parking lots, campuses, and city centers where monitoring extremely long distances is required.",
        connectivityOptions: "PoE+ support for simplified installation and integration.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Thermal Camera, Bi-Spectrum",
    categorySlug: "accessories",
    slug: "hikvision-bi-spectrum-thermal-bullet-ds-2td2628-3-qa",
    description: {
      overview: "A **Bi-spectrum Thermal and Optical Bullet camera** for perimeter protection, featuring deep learning analytics and accurate temperature measurement.",
      design: {
        title: "Design",
        formFactor: "Fixed bullet design with thermal and optical lenses in one unit.",
      },
      performance: {
        title: "Performance",
        processor: "Advanced AI distinguishes between human/vehicle targets based on thermal and optical data.",
        memory: "N/A",
        storage: "Supports MicroSD card storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Thermal sensor (256x192) and optical sensor (4MP).",
        graphics: "Features **audio alarm** and **two-way audio** for active deterrence and communication.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RJ-45 Gigabit Ethernet port", "Alarm I/O", "Audio I/O"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for critical infrastructure and areas with changing weather or lighting, providing reliable intrusion detection.",
        connectivityOptions: "PoE support simplifies installation and provides centralized power.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-3e0109p-e.jpg",
    category: "Hikvision, PoE Switch",
    categorySlug: "switches",
    slug: "hikvision-8-port-100mbps-unmanaged-poe-switch-ds-3e0109p-e-c",
    description: {
      overview: "An **8-Port 100Mbps Unmanaged PoE Switch** for simple and reliable power delivery to network devices like IP cameras and phones.",
      design: {
        title: "Design",
        formFactor: "Compact, desktop metal chassis with a fanless design for silent operation.",
      },
      performance: {
        title: "Performance",
        processor: "N/A",
      ...
      connectivity: {
        title: "Connectivity",
        ports: ["8x 10/100M PoE Ports", "1x 10/100M Uplink Port"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Features **Extended PoE Mode** for long-distance power and data transmission (up to 300m) on specific ports.",
        connectivityOptions: "Plug-and-play setup for rapid deployment of small-scale security systems.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Managed PoE Switch",
    categorySlug: "switches",
    slug: "hikvision-16-port-managed-gigabit-poe-switch-ds-3e1318p-e",
    description: {
      overview: "A **16-Port Managed Gigabit PoE Switch** with enhanced security and network control features, ideal for growing business networks.",
      design: {
        title: "Design",
        formFactor: "1U rack-mountable chassis.",
      },
      performance: {
        title: "Performance",
        processor: "N/A",
      ...
      connectivity: {
        title: "Connectivity",
        ports: ["16x Gigabit PoE Ports", "2x Gigabit Uplink Ports", "2x SFP Fiber Ports"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Supports VLAN, QoS, and PoE management, allowing administrators to prioritize traffic and control power delivery.",
        connectivityOptions: "Provides fiber SFP ports for high-speed uplink connections to a network core.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Managed PoE Switch",
    categorySlug: "switches",
    slug: "hikvision-24-port-managed-gigabit-poe-switch-ds-3e1326p-e",
    description: {
      overview: "A high-density **24-Port Managed Gigabit PoE Switch** designed for large enterprise or campus network edge deployments.",
      design: {
        title: "Design",
        formFactor: "1U rack-mountable chassis.",
      },
      ...
      connectivity: {
        title: "Connectivity",
        ports: ["24x Gigabit PoE Ports", "2x Gigabit Uplink Ports", "2x SFP Fiber Ports"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Full management capabilities including Layer 2 functions, security policies, and bandwidth control for high reliability.",
        connectivityOptions: "Provides fiber uplinks for long-distance, high-speed connections to the core network.",
      },
    },
  },
  {
    ...
    category: "Hikvision, DVR, Turbo HD",
    categorySlug: "accessories",
    slug: "hikvision-16-channel-turbo-hd-dvr-4-sata-ds-7316hqhi-k4",
    description: {
      overview: "A high-capacity **16-Channel Turbo HD DVR** with support for **4 SATA hard drives**, built for large analog/hybrid surveillance systems.",
      design: {
        title: "Design",
        formFactor: "2U rack-mountable DVR chassis, suitable for installation in a server rack.",
      },
      performance: {
        title: "Performance",
        processor: "Supports up to 4MP (Turbo HD) camera input.",
        memory: "N/A",
        storage: "Supports **four SATA hard drives** for massive local video archiving.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K UHD resolution.",
        graphics: "Decodes H.265+/H.265/H.264+ video streams.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["16x BNC inputs", "2x RJ-45 Gigabit Ethernet ports", "HDMI/VGA outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Ideal for enterprise installations requiring long recording retention times and high channel count in a reliable form factor.",
        connectivityOptions: "Hybrid capability allows integration of both analog (TVI/AHD/CVI) and IP cameras.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, 4K",
    categorySlug: "accessories",
    slug: "hikvision-4-channel-4k-nvr-ds-7604ni-k1",
    description: {
      overview: "A compact **4-Channel 4K NVR (K-Series)**, providing essential recording and management functions for small IP camera systems.",
      design: {
        title: "Design",
        formFactor: "Compact 1U NVR chassis supporting one SATA hard drive.",
      },
      performance: {
        title: "Performance",
        processor: "Supports up to 8MP/12MP camera resolution.",
        memory: "N/A",
        storage: "Supports one SATA hard drive (up to 8TB).",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI and VGA output supporting 4K UHD resolution.",
        graphics: "Decodes H.265+ video streams efficiently.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Ideal as a central recording solution for small retail or home offices with a limited number of high-resolution IP cameras.",
        connectivityOptions: "Supports plug-and-play connection with Hikvision IP cameras.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, 4K",
    categorySlug: "accessories",
    slug: "hikvision-8-channel-4k-nvr-ds-7608ni-k2",
    description: {
      overview: "An **8-Channel 4K NVR (K-Series)** with increased storage capacity, suitable for small to medium-sized IP surveillance systems.",
      design: {
        title: "Design",
        formFactor: "1U rack-mountable NVR chassis supporting two SATA hard drives.",
      },
      performance: {
        title: "Performance",
        processor: "Supports up to 8MP/12MP camera resolution.",
      ...
      display: {
        title: "Display and Graphics",
        screen: "HDMI and VGA output supporting 4K UHD resolution.",
        graphics: "Decodes H.265+ video streams for optimal bandwidth and storage savings.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for installations with up to eight high-resolution IP cameras and requirements for local, extended storage.",
        connectivityOptions: "Supports third-party network cameras via ONVIF protocol.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, PoE, M-Series",
    categorySlug: "accessories",
    slug: "hikvision-8-channel-4k-nvr-with-8-poe-ds-7608ni-m2-8p",
    description: {
      overview: "A high-performance **8-Channel 4K NVR (M-Series)** with a **built-in 8-port PoE switch**, offering powerful processing for demanding IP systems.",
      design: {
        title: "Design",
        formFactor: "1U rack-mountable NVR chassis supporting two SATA interfaces.",
      },
      performance: {
        title: "Performance",
        processor: "M-Series NVR provides increased performance and decoding capacity over K/I-series.",
        memory: "N/A",
        storage: "Supports two SATA hard drives.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K UHD resolution.",
        graphics: "The integrated **8-port PoE switch** powers cameras directly, simplifying installation and reducing cable runs.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["8x PoE Ports (for cameras)", "1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Ideal for systems requiring smart features and centralized power for up to eight high-resolution cameras.",
        connectivityOptions: "Plug-and-play configuration with Hikvision cameras.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, I-Series",
    categorySlug: "accessories",
    slug: "hikvision-16-channel-4k-nvr-2-sata-i-series-ds-7616ni-i2",
    description: {
      overview: "A professional **16-Channel 4K NVR (I-Series)** with robust decoding capability and support for two SATA drives, suitable for advanced security deployments.",
      design: {
        title: "Design",
        formFactor: "1U rack-mountable NVR chassis supporting two SATA interfaces.",
      },
      performance: {
        title: "Performance",
        processor: "I-Series provides superior performance for viewing and recording multiple high-resolution streams simultaneously.",
        memory: "N/A",
        storage: "Supports two SATA hard drives.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K UHD resolution.",
        graphics: "Decodes H.265+ efficiently for reduced storage cost.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for commercial environments that need high reliability and efficient management of up to 16 IP cameras.",
        connectivityOptions: "Supports third-party cameras and various advanced analytic functions.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, 4K",
    categorySlug: "accessories",
    slug: "hikvision-16-channel-4k-nvr-ds-7616ni-k2",
    description: {
      overview: "A reliable **16-Channel 4K NVR (K-Series)** offering high-resolution recording capability for medium-sized IP camera installations.",
      design: {
        title: "Design",
        formFactor: "1U rack-mountable NVR chassis supporting two SATA interfaces.",
      },
      ...
      display: {
        title: "Display and Graphics",
        screen: "HDMI and VGA output supporting 4K UHD resolution.",
        graphics: "Decodes H.265+ video streams for efficient storage.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for systems requiring a balance of channel count, 4K resolution support, and cost-effectiveness.",
        connectivityOptions: "Supports easy network connectivity and remote monitoring via Hik-Connect.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, PoE, M-Series",
    categorySlug: "accessories",
    slug: "hikvision-16-channel-4k-nvr-with-16-poe-ds-7616ni-m2-16p",
    description: {
      overview: "A high-power **16-Channel 4K NVR (M-Series)** featuring a **built-in 16-port PoE switch** for plug-and-play installation of a large IP camera system.",
      design: {
        title: "Design",
        formFactor: "1U rack-mountable NVR chassis supporting two SATA interfaces.",
      },
      performance: {
        title: "Performance",
        processor: "M-Series provides superior decoding and processing capacity for high-resolution streams.",
        memory: "N/A",
        storage: "Supports two SATA hard drives.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K UHD resolution.",
        graphics: "The **integrated 16-port PoE switch** provides centralized power and data, eliminating the need for an external switch.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["16x PoE Ports (for cameras)", "1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for rapid deployment of large-scale IP camera systems with simplified, centralized power management.",
        connectivityOptions: "Features a dedicated network interface for cameras and a separate one for the network/client.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, I-Series",
    categorySlug: "accessories",
    slug: "hikvision-32-channel-4k-nvr-2-sata-i-series-ds-7632ni-i2",
    description: {
      overview: "A powerful **32-Channel 4K NVR (I-Series)** with high decoding capacity, suitable for large installations needing to manage many camera feeds efficiently.",
      design: {
        title: "Design",
        formFactor: "1U rack-mountable NVR chassis supporting two SATA interfaces.",
      },
      performance: {
        title: "Performance",
        processor: "I-Series provides robust performance for continuous recording and multi-channel viewing.",
        memory: "N/A",
        storage: "Supports two SATA hard drives.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K UHD resolution.",
        graphics: "Decodes H.265+ for efficient storage management across all 32 channels.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for managing large-scale IP camera deployments in enterprise or commercial environments.",
        connectivityOptions: "Supports remote management and advanced analytic functions.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, 4K, 4SATA",
    categorySlug: "accessories",
    slug: "hikvision-16-channel-4k-nvr-4-sata-ds-7716ni-k4",
    description: {
      overview: "A high-capacity **16-Channel 4K NVR (77-Series)** with support for **four SATA hard drives**, designed for installations requiring maximum video retention.",
      design: {
        title: "Design",
        formFactor: "1.5U rack-mountable NVR chassis for greater hard drive capacity.",
      },
      performance: {
        title: "Performance",
        processor: "Supports up to 8MP/12MP camera resolution.",
        memory: "N/A",
        storage: "Supports **four SATA hard drives** (up to 6TB each).",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K UHD resolution.",
        graphics: "The 4-bay storage design allows for significantly longer continuous recording times.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for businesses or facilities with stringent regulatory requirements for long-term video retention.",
        connectivityOptions: "Robust storage and network capacity for reliable operation.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, 4K, 4SATA",
    categorySlug: "accessories",
    slug: "hikvision-32-channel-4k-nvr-4-sata-ds-7732ni-k4",
    description: {
      overview: "A maximum capacity **32-Channel 4K NVR (77-Series)** with support for **four SATA hard drives**, built for large-scale, high-retention IP systems.",
      design: {
        title: "Design",
        formFactor: "1.5U rack-mountable NVR chassis, optimizing space while supporting four internal drives.",
      },
      performance: {
        title: "Performance",
        processor: "Supports up to 8MP/12MP camera resolution across all 32 channels.",
        memory: "N/A",
        storage: "Supports **four SATA hard drives** for extensive local storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K UHD resolution.",
        graphics: "Decodes H.265+ efficiently to maximize the recording time available on the four hard drives.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Provides enterprise-level management for up to 32 IP cameras and extended storage for compliance or business intelligence.",
        connectivityOptions: "Robust connectivity for large network deployments.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, PoE, M-Series",
    categorySlug: "accessories",
    slug: "hikvision-32-channel-4k-nvr-16-poe-ds-7732ni-m4-16p",
    description: {
      overview: "A top-tier **32-Channel 4K NVR (M-Series)** with **16 integrated PoE ports**, offering superior performance and centralized power for a large IP camera network.",
      design: {
        title: "Design",
        formFactor: "1.5U rack-mountable NVR chassis supporting four SATA hard drives.",
      },
      performance: {
        title: "Performance",
        processor: "M-Series NVR provides maximum decoding and processing capacity.",
        memory: "N/A",
        storage: "Supports four SATA hard drives.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K UHD resolution.",
        graphics: "The integrated **16-port PoE switch** powers and connects cameras directly, simplifying installation of up to 16 cameras.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["16x PoE Ports (for cameras)", "1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Ideal for complex, high-performance systems where both high storage capacity and direct PoE connectivity are essential.",
        connectivityOptions: "Dedicated network interface for cameras and system management.",
      },
    },
  },
  {
    ...
    category: "Hikvision, NVR, Enterprise, 8SATA",
    categorySlug: "accessories",
    slug: "hikvision-64-channel-enterprise-4k-nvr-8-sata-ds-9664ni-m8",
    description: {
      overview: "An enterprise-class **64-Channel 4K NVR (96-Series)** with **8 SATA interfaces**, built for large-scale, mission-critical surveillance and control room environments.",
      design: {
        title: "Design",
        formFactor: "2U rack-mountable NVR chassis, optimized for extreme storage capacity and reliability.",
      },
      performance: {
        title: "Performance",
        processor: "Features powerful processing for decoding up to 32MP streams and supports high incoming bandwidth.",
        memory: "N/A",
        storage: "Supports **eight SATA hard drives** (up to 10TB each) for massive long-term storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "Dual HDMI output supporting 4K UHD resolution.",
        graphics: "Provides the capacity needed for large campus, city, or critical infrastructure monitoring projects.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["2x RJ-45 Gigabit Ethernet ports", "8x SATA Interfaces", "Dual HDMI/VGA outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Top-tier reliability and storage capacity for complex video management systems.",
        connectivityOptions: "Features hot-swappable hard drive trays (depending on configuration) and redundant network interfaces.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Surveillance Monitor, LED",
    categorySlug: "accessories",
    slug: "hikvision-21-5-inch-full-hd-surveillance-monitor-ds-d5022fn-c",
    description: {
      overview: "A **21.5-inch Full HD LED monitor** specifically designed for **24/7 video surveillance** use, offering reliability and image quality superior to consumer monitors.",
      design: {
        title: "Design",
        formFactor: "Slim-bezel desktop monitor with VESA mounting capability.",
      },
      performance: {
        title: "Performance",
        processor: "N/A",
      ...
      display: {
        title: "Display and Graphics",
        screen: "21.5-inch Full HD (1920x1080) LED display.",
        graphics: "Designed for continuous operation with specialized components for video stability and longevity.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["HDMI input", "VGA input"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "High color fidelity, wide viewing angle, and fast response time make it ideal for security control rooms.",
        connectivityOptions: "Plug-and-play connection to DVRs, NVRs, and PCs.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ds-k1201mf.jpg",
    category: "Hikvision, Access Control, Fingerprint Reader",
    categorySlug: "accessories",
    slug: "hikvision-fingerprint-mifare-access-control-reader-ds-k1201mf",
    description: {
      overview: "A versatile **Access Control Reader** featuring **fingerprint recognition** and **Mifare card technology** for highly secure, multi-factor authentication.",
      design: {
        title: "Design",
        formFactor: "Compact, wall-mounted terminal with a backlit keypad and integrated fingerprint sensor.",
      },
      performance: {
        title: "Performance",
        processor: "Fast fingerprint authentication and card reading technology.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "LED indicators for access status (Grant/Deny).",
        graphics: "N/A",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["RS-485 and Wiegand interfaces", "Tamper alarm"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Provides superior security by requiring both physical card presentation and biometric verification.",
        connectivityOptions: "Connects to Hikvision access controllers or third-party Wiegand controllers.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Access Control, Terminal",
    categorySlug: "accessories",
    slug: "hikvision-outdoor-pro-access-control-terminal-ds-k1t500s",
    description: {
      overview: "A professional, **outdoor-rated Access Control Terminal** with built-in card reading and security functions, designed for high-traffic environments.",
      design: {
        title: "Design",
        formFactor: "Wall-mounted terminal with IP67 weatherproof and IK10 vandal-resistant ratings.",
      },
      performance: {
        title: "Performance",
        processor: "Supports card, password, and combination access modes.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "Keypad and LED indicators for access status.",
        graphics: "N/A",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["Wiegand interface", "RS-485 interface", "Alarm I/O"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Can be used as a simple card reader or a complex, self-contained access control terminal.",
        connectivityOptions: "Robust connectivity for integration with electric locks, exit buttons, and alarm systems.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Access Control, Terminal",
    categorySlug: "accessories",
    slug: "hikvision-basic-pro-access-control-terminal-ds-k1t501sf",
    description: {
      overview: "A **Basic Pro Access Control Terminal** featuring card reading, optional fingerprint scanning, and door management functions.",
      design: {
        title: "Design",
        formFactor: "Wall-mounted terminal with a simple, gray aesthetic.",
      },
      performance: {
        title: "Performance",
        processor: "Supports various card types (e.g., Mifare) and fingerprint templates (optional).",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "LED indicators and simple keypad.",
        graphics: "N/A",
      },
      connectivity: {
        title: "Connectivity",
      ...
      functionality: {
        title: "Functionality",
        versatility: "Provides core access control functionality at a cost-effective price point, including door status monitoring and exit button control.",
        connectivityOptions: "Easily integrates with Hikvision controllers for network management.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Access Control, Terminal",
    categorySlug: "accessories",
    slug: "hikvision-standalone-em-card-fingerprint-terminal-ds-k1t804ef-1",
    description: {
      overview: "A **Standalone Access Control Terminal** with **EM Card and Fingerprint** authentication, ideal for small offices that need a single, secure entry point.",
      design: {
        title: "Design",
        formFactor: "Wall-mounted terminal with a numeric keypad and backlit display.",
      },
      performance: {
        title: "Performance",
        processor: "Stores up to 3,000 fingerprints and 3,000 cards for local authentication.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "Small LCD display for user feedback and basic configuration.",
        graphics: "N/A",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["Wiegand interface", "RS-485 interface", "Door Sensor Input"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Operates independently (standalone) without a central controller. Supports multiple authentication modes (card, fingerprint, or combination).",
        connectivityOptions: "Provides direct control over the electric lock and exit button.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Access Control, Terminal",
    categorySlug: "accessories",
    slug: "hikvision-standalone-mifare-fingerprint-terminal-ds-k1t804mf-1",
    description: {
      overview: "A **Standalone Access Control Terminal** with **Mifare Card and Fingerprint** authentication, offering secure local access management.",
      design: {
        title: "Design",
        formFactor: "Wall-mounted terminal with a numeric keypad and integrated fingerprint sensor.",
      },
      performance: {
        title: "Performance",
        processor: "Stores up to 3,000 fingerprints and 3,000 Mifare cards for local authentication.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "Small LCD display for user feedback.",
        graphics: "N/A",
      },
      connectivity: {
        title: "Connectivity",
      ...
      functionality: {
        title: "Functionality",
        versatility: "Provides highly secure access via fingerprint and card reading. Operates in standalone mode for simple installations.",
        connectivityOptions: "Controls door lock mechanisms directly.",
      },
    },
  },
  {
    ...
    category: "Hikvision, Video Intercom System",
    categorySlug: "accessories",
    slug: "hikvision-7-inch-analogue-video-intercom-kit-ds-kis203",
    description: {
      overview: "A complete **Analogue Video Intercom Kit** with a 7-inch indoor station, providing basic video communication and door control for residential applications.",
      design: {
        title: "Design",
        formFactor: "Includes a sleek 7-inch indoor station and a durable outdoor door station.",
      },
      performance: {
        title: "Performance",
        processor: "Door station features a high-resolution analog camera and speaker/mic.",
        memory: "N/A",
        storage: "N/A",
      },
      display: {
        title: "Display and Graphics",
        screen: "7-inch color display on the indoor station.",
        graphics: "Outdoor station provides clear video with IR illumination for night view.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["Four-wire connection between units", "Door lock control output"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Provides two-way audio and video communication, allowing users to safely verify visitors before granting access.",
        connectivityOptions: "Simple analog wiring makes it easy to install or replace older intercom systems.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ids-7208hqhi-k1-4s.jpg",
    category: "Hikvision, DVR, AcuSense",
    categorySlug: "accessories",
    slug: "hikvision-8-channel-acusense-turbo-hd-dvr-ds-7208hqhi-k1-4s",
    description: {
      overview: "An **8-Channel Turbo HD DVR** featuring **AcuSense AI technology** on **4 channels**, providing intelligent human/vehicle filtering for analog cameras.",
      design: {
        title: "Design",
        formFactor: "Compact desktop DVR chassis supporting one SATA hard drive.",
      },
      performance: {
        title: "Performance",
        processor: "Integrated AcuSense AI chip enables accurate classification of motion events, drastically reducing false alarms.",
        memory: "N/A",
        storage: "Supports one SATA hard drive.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI and VGA output supporting Full HD resolution.",
        graphics: "Supports up to 4MP HD-TVI input.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["8x BNC inputs", "1x RJ-45 Gigabit Ethernet port", "HDMI/VGA outputs"],
        wireless: ["N/A"],
      },
      functionality: {
        title: "Functionality",
        versatility: "Brings modern AI capability to traditional coaxial/analog surveillance cameras on the first four channels.",
        connectivityOptions: "Hybrid capability allows connection of both analog and IP cameras.",
      },
    },
  },
  {
    ...
    price: "Get a Quote",
    image: "/hikvision/ids-7316hqhi-m4-s.jpg",
    category: "Hikvision, DVR, AcuSense",
    categorySlug: "accessories",
    slug: "hikvision-16-channel-acusense-turbo-hd-dvr-ds-7316hqhi-m4-s",
    description: {
      overview: "A professional **16-Channel Turbo HD DVR (M-Series)** with **AcuSense AI** and support for **4 SATA drives**, built for large, intelligent hybrid systems.",
      design: {
        title: "Design",
        formFactor: "1.5U rack-mountable DVR chassis supporting four SATA interfaces.",
      },
      performance: {
        title: "Performance",
        processor: "Integrated AcuSense AI chip provides superior human and vehicle detection and filtering across all 16 analog channels.",
        memory: "N/A",
        storage: "Supports four SATA hard drives for massive local storage.",
      },
      display: {
        title: "Display and Graphics",
        screen: "HDMI output supporting 4K UHD resolution.",
        graphics: "M-Series processing provides enhanced decoding performance and stability.",
      },
      connectivity: {
        title: "Connectivity",
        ports: ["16x BNC inputs", "2x RJ-45 Gigabit Ethernet ports", "HDMI/VGA outputs"],
      ...
      functionality: {
        title: "Functionality",
        versatility: "Brings advanced AI analytics, deep storage capacity, and superior reliability to a large-scale analog or hybrid installation.",
        connectivityOptions: "Dual Gigabit Ethernet ports provide network redundancy and high throughput.",
      },
    },
  },
